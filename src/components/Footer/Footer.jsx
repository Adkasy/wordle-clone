  ...
  return (
    <div className="footer-container">
      <div className="footer-content">
        <p className="footer-text footer-hide-mobile">Keep guessing, keep winning!</p>
        ...
        <p className="footer-text footer-separator">|</p>
        <a href="https://github.com/Adkasy" className="footer-text footer-github" target="_blank" rel="noopener noreferrer">
